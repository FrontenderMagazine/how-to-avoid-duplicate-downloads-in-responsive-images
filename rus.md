...
<tr>
    <th>IE 6</th><td>изображение отсутствует</td><td>изображение отсутствует</td><td>изображение отсутствует</td><td>изображение отсутствует</td><td>резервное</td>
</tr>
<tr>
    <th>IE 7</th><td>изображение отсутствует</td><td>изображение отсутствует</td><td>изображение отсутствует</td><td>изображение отсутствует</td><td>резервное</td>
</tr>
<tr>
    <th>IE 8</th><td>резервное</td><td>изображение отсутствует</td><td>резервное</td><td>резервное</td><td>резервное</td>
</tr>
<tr>
    <th>IE 9</th><td>резервное</td><td>резервное (обрезанное, с полосками прокрутки)</td><td>резервное</td><td>резервное</td><td>резервное</td>
</tr>
<tr>
    <th>IE 10</th><td>резервное</td><td>резервное (обрезанное, с полосками прокрутки)</td><td>резервное</td><td>резервное</td><td>резервное</td>
</tr>
<tr>

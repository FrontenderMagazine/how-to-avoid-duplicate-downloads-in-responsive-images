...
немедленно начинают загрузку изображений. Вот как Йоав это объясняет:
...
содержимое `<picture>` пассивным, как содержимое `<template>`, и использовать
...
безумно объемное; никто будучи в здравом уме не захочет писать столько кода
